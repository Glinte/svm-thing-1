...
train_data: np.ndarray[tuple[N_IMAGES, Literal[32], Literal[32]], np.dtype[np.float64]] = np.concatenate(
...
test_data: np.ndarray[tuple[N_IMAGES, Literal[32], Literal[32]], np.dtype[np.float64]] = _test_data["data"].astype(np.float64)
