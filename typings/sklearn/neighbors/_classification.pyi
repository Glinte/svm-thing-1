...
class KNeighborsClassifier(KNeighborsMixin, ClassifierMixin, NeighborsBase):
    ...
    def fit(self: KNeighborsClassifier_Self, X: MatrixLike | ArrayLike, y: MatrixLike | ArrayLike) -> KNeighborsClassifier_Self: ...
    def predict(self, X: ArrayLike | MatrixLike) -> ndarray: ...
